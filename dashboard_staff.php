            ...
            <div class="d-flex flex-row">
                ...
                <div class="col-md-3">
                    <div class="card card1 p-3">
                        ...
                        <hr class="hline">
                        <a href="profile_admin.php" class="btn btn-primary">Profil Staf</a><br>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card2 p-3">
                        <div class="hello d-flex justify-content-end align-items-center mt-3">Selamat Sejahtera, Staf</div>
                    </div>
